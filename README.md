...
# Travel Rogue - Gateway to Seamless Smart Travel

Welcome to Travel Rogue, your ultimate travel companion designed to simplify the process of planning your next adventure.
Whether you're dreaming of a weekend getaway or a month-long expedition, Travel Rogue is here to help you meticulously craft your next travel itinerary.

## Overview

Travel Rogue is a Software as a Service (SaaS) product that leverages cutting-edge technologies to streamline the travel planning process.
...
![image](https://github.com/hardikverma22/travel-rogue/assets/26103679/de21a51b-6d95-427c-a00a-b919dd09c56e)

## Demo

Check out the live demo [﻿here](https://travelrogue.site/).
...
To run the Travel Rogue, follow these steps:

1. Clone the repository:git clone [﻿https://github.com/hardikverma22/travel-rogue](https://github.com/hardikverma22/travel-rogue)
2. Navigate to the project directory:cd travel-rogue
...
- Travel Rogue is built using cutting-edge technologies to ensure a seamless user experience.
...
Contributions are welcome! If you'd like to contribute to Travel Rogue, please follow these steps:
