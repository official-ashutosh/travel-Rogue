    ...
    <div className="relative min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-32 right-20 animate-pulse">
          <div className="w-20 h-12 bg-white/20 rounded-full blur-sm"></div>
        </div>
        <div className="absolute top-40 left-1/3 animate-bounce">
          <div className="w-12 h-8 bg-white/25 rounded-full blur-sm"></div>
        </div>
        ...
        <div className="absolute bottom-1/4 left-1/5 animate-bounce">
          <div className="p-3 bg-orange-500/10 rounded-full backdrop-blur-sm">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" className="px-8 py-3 rounded-full bg-white/80 backdrop-blur-sm hover:bg-gray-50 transition-colors">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900">Tokyo, Japan</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <span className="text-sm text-gray-700">March 15 - March 22, 2024</span>
                  </div>

                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    <Users className="w-5 h-5 text-green-600" />
                    <span className="text-sm text-gray-700">2 Adults, 1 Child</span>
                  </div>

                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    <Plane className="w-5 h-5 text-purple-600" />
                    <span className="text-sm text-gray-700">Round-trip flights included</span>
                  </div>
                </div>

                {/* Activities Preview */}
                <div className="space-y-3">
                  <h4 className="font-medium text-gray-900">Planned Activities</h4>
...
const HowItWorksSection = () => {
  ...
  return (
    <section className="min-h-screen bg-white/90 w-full flex justify-center items-center px-5 py-20">
      <div className="flex flex-col gap-20">
        <div className="flex flex-col gap-5">
          <h2 className="text-blue-500 text-center text-lg font-bold tracking-wide">
            How it works?
          </h2>
          <h3 className="text-gray-900 text-center md:text-3xl text-xl font-bold">
        ...
        <div className="flex items-center justify-center gap-28 w-full h-full flex-col md:flex-row">
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col items-center justify-center gap-5 relative">
              ...
              <span className="font-bold tracking-wide text-lg mt-5">{step.title}</span>
              <span className="text-sm w-2/3 text-center text-gray-600">{step.description}</span>
              {index < steps.length - 1 && (
                <ChevronRight className="absolute -right-[120px] top-[15%] opacity-40 hidden md:block" />
              )}
            </div>
          ))}
        </div>
            ...
            <Card key={plan.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-4">
                ...
                <div className="flex justify-between items-center mb-3">
                  ...
                  <span className="font-bold text-blue-600">{plan.budget}</span>
                </div>
...
const PricingSection = () => {
  ...
  return (
    <section className="min-h-screen bg-white w-full flex flex-col gap-5 justify-center items-center px-5 py-20">
      ...
      <div className="flex gap-5 flex-col md:flex-row">
        {plans.map((plan, index) => (
          <Card key={index} className="flex flex-col justify-between flex-1 min-w-96 md:min-w-80 ring-1 ring-gray-200 rounded-3xl p-8 shadow-xl">
            <div className="flex flex-col">
              ...
              <p className="mt-3 flex items-baseline gap-x-1">
                <span className="line-through text-2xl font-sans text-gray-400">{plan.originalPrice}</span>
            ...
            <div className="flex flex-col">
              ...
              <p className="text-xs text-gray-600 font-medium mt-5">
                {plan.description}
              </p>
            </div>
          </Card>
