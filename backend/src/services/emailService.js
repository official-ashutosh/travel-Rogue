...
const sendWelcomeEmail = async (email, firstName) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: 'Welcome to Travel Planner AI!',
    html: `
      <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif;">
        <h1 style="color: #2563eb;">Welcome to Travel Planner AI!</h1>
        <p>Hi ${firstName},</p>
        <p>Welcome to Travel Planner AI! We're excited to help you plan your next adventure.</p>
        ...
        <p>Happy travels!</p>
        <p>The Travel Planner AI Team</p>
      </div>
    `
  };
...
const sendPasswordResetEmail = async (email, resetToken, firstName) => {
  ...
  const mailOptions = {
    from: process.env.EMAIL_USER,
    to: email,
    subject: 'Reset Your Password - Travel Planner AI',
    html: `
      <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif;">
        <h1 style="color: #2563eb;">Reset Your Password</h1>
        <p>Hi ${firstName},</p>
        <p>We received a request to reset your password for your Travel Planner AI account.</p>
...
const sendFeedbackAcknowledgmentEmail = async (email, firstName, feedbackType) => {
  ...
  const mailOptions = {
    from: process.env.EMAIL_USER,
    to: email,
    subject: 'Thank you for your feedback - Travel Planner AI',
    html: `
      <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif;">
        <h1 style="color: #2563eb;">Thank You for Your Feedback!</h1>
        <p>Hi ${firstName},</p>
        <p>Thank you for taking the time to share your ${feedbackType} with us. Your feedback is valuable and helps us improve Travel Planner AI.</p>
        ...
        <p>We appreciate your support in making Travel Planner AI better for everyone!</p>
        <p>Best regards,</p>
        <p>The Travel Planner AI Team</p>
      </div>
    `
